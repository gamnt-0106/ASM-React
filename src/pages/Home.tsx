            ...
            <div className="col-lg-6">
              <div className="left-content">
                <div className="thumb">
                  ...
                  <img src="src/images/left-banner-image.jpg" alt="" />
                </div>
              </div>
            </div>
            <div className="col-lg-6">
                ...
                <div className="owl-men-item owl-carousel">
                  ...
                  <div className="item">
                    <div className="thumb">
                      ...
                      <img src="src/images/men-02.jpg" alt="" />
                    </div>
                    <div className="down-content">
                      <h4>Air Force 1 X</h4>
                      <span>$90.00</span>
                ...
                <div className="owl-women-item owl-carousel">
                  <div className="item">
                    <div className="thumb">
                      ...
                      <img src="src/images/women-01.jpg" alt="" />
                    </div>
                    <div className="down-content">
                  ...
                  <div className="item">
                    <div className="thumb">
                      ...
                      <img src="src/images/women-02.jpg" alt="" />
                    </div>
                    <div className="down-content">
                  ...
                  <div className="item">
                    <div className="thumb">
                      ...
                      <img src="src/images/women-03.jpg" alt="" />
                    </div>
                    <div className="down-content">
                ...
                <div className="owl-kid-item owl-carousel">
                  <div className="item">
                    <div className="thumb">
                      ...
                      <img src="src/images/kid-01.jpg" alt="" />
                    </div>
                    <div className="down-content">
                  ...
                  <div className="item">
                    <div className="thumb">
                      ...
                      <img src="src/images/kid-03.jpg" alt="" />
                    </div>
                    <div className="down-content">
          ...
          <div className="row images">
            ...
            <div className="col-2">
              <div className="thumb">
                ...
                <img src="src/images/instagram-05.jpg" alt="" />
              </div>
            </div>
            <div className="col-2">
              <div className="thumb">
